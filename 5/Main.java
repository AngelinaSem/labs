...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(removeRepeating("aatyuhhkk"));

        // Проверка, что две строки анаграммы
        isAnagramme("abcd", "dbac");
        isAnagramme("abcd", "dnfde");
        ...
        String s8 = "Stutter";
        String result4 = (s7.endsWith(s8)) ? "заканчивается - " + s8 : "не заканчивается - " + s8;
        ...
        System.out.println(getSecondMostPopularChar("aatyuhhkkk"));

        // Первый неповторяющийся символ
        System.out.println(getFirstNonRepeatingChar("aatyuhhkk"));

        // Без дубликатов
        System.out.println(getOrderedNonRepeatingCharacters("aatyuhhkk"));
        ...
        System.out.println(getTripleCharCount("sfffjjjy"));
